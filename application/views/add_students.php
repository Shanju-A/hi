    ...
    <div class="main">
        <form action="<?php echo base_url()."index.php/Main/insert"; ?>" method="post">
            <fieldset>
                ...
                <input type="text" name="student_name" value="<?php echo set_value('student_name');?>" placeholder="Student Name">
                <input type="text" name="roll_no" value="<?php echo set_value('roll_no');?>" placeholder="Roll No">
